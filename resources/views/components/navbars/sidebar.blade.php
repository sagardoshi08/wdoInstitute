    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-700" id="sidenav-collapse-main">
       <ul class="navbar-nav toffel">
          ...
          <li class="">
             ...
             <ul class="collapse {{ Route::currentRouteName() == 'add' || Route::currentRouteName() == 'all-active-user' || Route::currentRouteName() == 'attendance' || Route::currentRouteName() == 'user2-management' ? 'show' : '' }} nav flex-column ms-1" id="submenu3" data-bs-parent="#menu">
             <li class="w-100">
