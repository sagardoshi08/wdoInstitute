...
<div class="m-3 text-img">
   ...
   <div class="row personal-ils ">
    ...
    <div class="frustration col-lg-5 p-0">
        ...
        <textarea id="text-fres" name="text" rows="4" cols="39" readonly>{{$user->frustrations}}</textarea>
        ...
        <textarea id="text-fres" name="text" rows="4" cols="39" readonly>{{$user->goal}}</textarea>
...
@if($user->job_status == 'Pending' || $user->job_status == 'Defect')
<div class="row01">
    <div class="name_line_p">

            <h3 class="name_action">
   ...
   <div class="students-start">
      <div class="students-text">
         ...
         <div class="four-btn">
            <button class="rj-btn reject-user-btn" status="Reject">REJECT</button>
            <button class="rj-btn all-bt detect-user-btn" status="Defect">DEFECT</button>
            <button class="rj-btn all-bt-01 send-letter">SEND OFFER LETTTER</button>
            <button class="rj-btn all-bt-02">RECHIVE JOINING LETTTER</button>
            <button class="rj-btn all-bt-03 aprove-user" status="Approved">FINALE APPROVED</button>
         </div>
      </div>
   </div>
</div>
