    ...
    <div class="row">
        ...
        <div class="bg-white px-0 pb-0 sm:p-6 sm:pb-4">
            <div class="m-3 text-img">
                <img class="img-account-profile p-img" width="100px" height="100px" src="#" alt="">
                ...
                <div class="light-mon">
                    ...
                    <div class="col-sm-3 mt-4">
                        <div class="form-group">
                            ...
                            <input type="date" id="fromdate" name="fromdate" class="form-control form-control w-100 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" max="{{date('Y-m-d')}}" value="" required>
                        </div>
                    </div>
                    <div class="col-sm-3 mt-4">
                        <div class="form-group">
                            <label for="todate" class=""><b>Todate</b></label><br />
                            <input type="date" id="todate" name="todate" class="form-control form-control w-100 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="todate" max="{{date('Y-m-d')}}" value="" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="m-3 text-img">
                        <div class="col-sm-3 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="total-working-hour" name="total_working_hour" class="form-control form-control w-100 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="">
                                </div>
                            </div>
                            <div class="col-sm-3 mt-3">
                                <div class="form-group">
                                    <label for="total-active-hour" class=""><b>Total active hours</b></label><br />
                                    <input type="text" id="total-active-hour" name="total_active_hour" class="form-control form-control w-100 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="">
                                </div>
                            </div>
                            <div class="col-sm-3 mt-3">
                                <div class="form-group">
                                    <label for="total-due-hour" class=""><b>Total Due hours</b></label><br />
                                    <input type="text" id="total-due-hour" name="total_due_hour" class="form-control form-control w-100 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="">
                                </div>
                            </div>
                        </div>
                        <div class="m-3 text-img">
                            <div class="col-sm-3 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="total-extra-hour" name="total_extra_hour" class="form-control form-control w-100 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="">
                                </div>
                            </div>
                        </div>
            </div>
