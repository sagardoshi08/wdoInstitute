<div id="user2" class="container-fluid manager-listing py-4">
@if(!$isAssign)
...
@endif
    <div class="row">
        ...
        <div class="col-12">
			...
			@if(!$isAssign)
            @if(!$isOpen)
                <div class="col-lg-6 d-flex align-items-center gap-3 Manager" style="justify-content:space-between;">
                <h2>{{count($users)}} Manager</h2>
