...
<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900|Roboto+Slab:400,700">@include('components.include.header')
<div id="user2" class="container-fluid py-4 all-user-listing">
    <div class="row">
        <div class="col-12">
            ...
            @endif
            <h2>{{count($users)}} Reject Admin</h2>
            <div class="my-4">
