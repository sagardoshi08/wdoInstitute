...
<div class="inner-table-wrapper fundraise-listing">
	<div class="container">
		<h4 class="mt-4"><i class="fa fa-phone" aria-hidden="true"></i> <span class="title-text"><b>Fundraise</b></span>  <span class="title-count">({{getFundraiseCount()}} total)</span><span><button class="add-button btn btn-secondary" style="right: 20px; position: absolute;">Add</button></span></h4>
			<div class="card mt-4">
				<div class="card-body">
						...
						<div class="-page-row filter-datatable">
							<div class="col_filed">
								...
								<select name="column_name" id="column_name" class="form-control selectpicker" multiple>
									...
									<option value="1" selected>Fundraise Name</option>
								...
								<div class="filter-data">
									...
									<div class="select_opt">
										<select name="field_name" id="field-name" style="width:100%;" class="form-control">
											...
											<option value="name">Fundraise Name</option>
  	...
  	<div class="modal-dialog" style="display: flex; align-items: center; width: 420px; height: 649px;" role="document">
	    <div class="modal-content">
	      	<div class="modal-header" style="margin: 0 24px;">
	        	<h5 class="modal-title" id="exampleModalLabel">Add Fundraise</h5>
		    ...
		    <div class="modal-body">
		      	<form method="post" id="fundraise-form">
		      		...
		      		<div class="form-group">
		        		...
		        		<input  class="form-control" type="text" name="fundraiser_token_id" id="fundraiser_token_id">
		      		</div>
		      		<div class="form-group">
...
$(document).ready(function(){
    ...
    $(document).on('submit', '#user-pages', function(event) {
        ...
        $.ajax({
            type:'POST',
            url:"{{ route('admin.deactiveFundraise') }}",
    ...
    $(document).on('submit', '#user-pages-unblock', function(event) {
        ...
        $.ajax({
            type:'POST',
            url:"{{ route('admin.activeFundraise') }}",
